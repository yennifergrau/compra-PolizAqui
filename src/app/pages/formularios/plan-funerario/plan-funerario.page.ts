...
export class PlanFunerarioPage implements OnInit,AfterViewChecked {
  ...
  private emailUsuario : string | any
  ...
  public isPoliticallyExposed: boolean = false;
  public isIncomeDeclared: boolean = false;
...
public EstadoTI(event: Event): void {
 ...
 public selectEstadoTI(estado: Estado): void {
  ...
  if (inputElement) {inputElement.value = estado.xdescripcion_l}
...
private informacionOcrStorage() {
  ...
  routingNavigate() {
    this.navController.navigateForward('9d3a6e2b1f7c4d8e5b9a4c7f8a1d2c9');
  }
...
public getInfoData() {
  ...
  public togglePoliticallyExposed() {
    this.isPoliticallyExposed = !this.isPoliticallyExposed;
  }

  public toggleIncomeDeclaration() {
